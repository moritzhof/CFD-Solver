...
void remove_obstacles(double **U, double **V, double **P, int **flag, int imax, int jmax){
...
void calculate_dt(double Re,
                  ...
                  int jmax,
                  double **U,
                  double **V,double Pr, int includeTemp)
{
...
void calculate_fg(double Re, double GX, double GY, double alpha, double dt, double dx, double dy,
		 int imax, int jmax, double** U, double** V, double** F, double** G,int **flag, double beta, double** temp, int includeTemp)
{
...
switch(select)
{
  ...
  break;
	...
	for(int j=0; j<jmax; j++)
	{
		temp[0][j] = 2*T_c - temp[1][j];
		temp[imax-1][j] = 2*T_h - temp[imax-2][j];
	}
	break;
